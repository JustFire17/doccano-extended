...
1. Open a private report using GitHub Security Advisories (preferred)
2. If private reporting is unavailable, create a GitHub issue without exploit details
3. Include clear reproduction steps and impact details
...
For security-related questions, use GitHub Security Advisories for private reports.
If private reporting is unavailable, create a GitHub issue without exploit details.
