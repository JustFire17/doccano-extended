    ...
    <v-card>
      ...
      <v-card-text>
        ...
        <v-row v-if="!loading && showResults">
          <v-col v-for="(annotation, annotationIndex) in annotationResults" :key="annotationIndex" cols="12">
...
export default Vue.extend({
  ...
  methods: {
      ...
      try {
        ...
        element.innerHTML = `
          ...
          <div style='margin-top: 20px;'>
            ${this.annotationResults.map((annotation, index) => `
        ...
        const opt = {
          margin: 1,
          filename: `annotation_statistics_${this.currentProject.name}_${new Date().toISOString().split('T')[0]}.pdf`,
    ...
    exportToCSV() {
      ...
      link.setAttribute('download', `annotation_statistics_${this.currentProject.name}_${new Date().toISOString().split('T')[0]}.csv`)
