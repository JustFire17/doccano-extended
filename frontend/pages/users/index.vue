              ...
              <v-col cols="12">
                <v-card outlined>
                  ...
                  <v-card-text>
                    ...
                    <v-chip
                      v-if="selectedUser.is_superuser"
                      color="red"
                      text-color="white"
                      class="ml-2"
                    >
      ...
      try {
        ...
        if (error.response?.data) {
          ...
          if (
            ...
            this.generalError =
              'An error occurred while updating the user. Please check your data and try again.'
          }
      ...
      if (confirm('Are you sure you want to delete this user?')) {
        try {
          ...
          if (response.status === 200) {
            ...
            alert(
              'This user is associated with projects and cannot be deleted. They have been deactivated instead.'
            )
          } else {
