...
export class PerspectiveApplicationService {
  ...
  async createPerspectiveWithItems(
    projectId: string | number,
  ...
  public async associatePerspective(
    projectId: number,
    perspectiveProjectId: number
  ): Promise<void> {
    const data: AssociatePerspectiveDTO = {
      project_id: projectId,
      perspective_project_id: perspectiveProjectId
    }
