<template>
  <v-dialog :value="dialog" max-width="500px" @input="updateDialog">
    <v-card>
      <v-card-title class="headline"> Delete Perspective </v-card-title>
      <v-card-text>
        <v-select
        ...
        >
          <template #no-data>
            <v-list-item>
              <v-list-item-content>
                <v-list-item-title> No perspectives available </v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </template>
        </v-select>
        <v-alert v-if="selectedPerspective" type="warning" class="mt-3">
      ...
      <v-card-actions>
        ...
        <v-btn color="error" :disabled="!selectedPerspective" @click="deletePerspective">
          Delete
        </v-btn>
      </v-card-actions>
    </v-card>
