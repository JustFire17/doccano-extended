<template>
  <v-app-bar app clipped-left>
    ...
    <v-btn v-if="isAuthenticated && isIndividualProject" text class="d-none d-sm-flex" style="text-transform: none">
      ...
      <span> {{ currentProject.name }} ({{ currentProject.displayVersion }})</span>
    </v-btn>
    ...
    <v-btn v-if="isAuthenticated && is_superuser" text class="text-capitalize" @click="$router.push(localePath('/groups'))">
      Groups
    </v-btn>
