...
export const fileFormatRules = (msg) => {
  return {
    version: '1.0.0',
    rules: [(v) => !!v || msg.fileFormatRequired]
  }
}
...
export const uploadSingleFileRules = (msg) => {
  return {
    version: '1.0.0',
    rules: [(v) => !!v || msg.fileRequired, (v) => !v || v.size < 1000000 || msg.fileLessThan1MB]
  }
}
