...
import { ApiManualDiscrepancyRepository } from '@/repositories/discrepancy/apiManualDiscrepancyRepository'
import { ApiReportRepository } from '@/repositories/report/apiReportRepository'
...
export interface Repositories {
  ...
  // Discrepancy
  manualDiscrepancy: ApiManualDiscrepancyRepository
...
const repositories: Repositories = {
  ...
  // Discrepancy
  manualDiscrepancy: new ApiManualDiscrepancyRepository(),
