...
urlpatterns = [
    ...
    path(
        route="projects/<int:project_id>/perspectives/<int:perspective_id>",
        view=PerspectiveList.as_view(),
        name="perspective_detail",
    ),
    path(
        route="projects/<int:project_id>/perspectives/create-with-items",
        view=CreatePerspectiveWithItems.as_view(),
        name="perspective_create_with_items",
    ),
    path(
        "projects/<int:project_id>/associate-perspective",
        AssociatePerspectiveView.as_view(),
        name="associate_perspective",
    ),
    path(route="projects/<int:project_id>/perspectives/fill", view=FillPerspectives.as_view(), name="perspective_fill"),
    path(
        "projects/<int:project_id>/perspectives/fill/values",
        GetFilledPerspectives.as_view(),
        name="get_filled_perspectives",
    ),
    path(
        "projects/<int:project_id>/perspectives/fill/all-values",
        GetAllFilledValues.as_view(),
        name="get_all_filled_values",
    ),
    path(
        "projects/<int:project_id>/perspectives/fill/users-with-value",
        GetUsersWithValue.as_view(),
        name="get_users_with_value",
    ),
    path("projects/<int:project_id>/AllPerspectives", AllPerspectivesView.as_view(), name="all_perspectives"),
    path(
        route="projects/<int:project_id>/perspectives/<int:perspective_id>/delete-total",
        view=DeletePerspectiveTotal.as_view(),
        name="perspective-delete-total",
    ),
    ## Reports
    path(
        route="projects/<int:project_id>/reports/annotators",
        view=AnnotatorReportView.as_view(),
        name="annotator_report",
    ),
    path(
        route="projects/<int:project_id>/annotation-statistics",
        view=AnnotationStatisticsView.as_view(),
        name="annotation-statistics",
    ),
    path(
        route="projects/<int:project_id>/all-versions-statistics",
        view=AllVersionsStatisticsView.as_view(),
        name="all-versions-statistics",
    ),
    path(
        "projects/<int:project_id>/annotation-label-table/",
        AnnotationLabelTableView.as_view(),
        name="annotation-label-table",
    ),
    ## Discrepancy
    path(
        route="projects/<int:project_id>/discrepancies",
        view=DiscrepancyAnalysisView.as_view(),
        name="discrepancy-analysis",
    ),
    path(
        route="projects/<int:project_id>/annotations-by-user",
        view=AnnotationsByUserView.as_view(),
        name="annotations-by-user",
    ),
    path(
        route="projects/<int:project_id>/discrepancies/create",
        view=ManualDiscrepancyListCreate.as_view(),
        name="manual-discrepancy-create",
    ),
    path(
        route="projects/<int:project_id>/examples/<int:example_id>/label-stats",
        view=LabelStatsView.as_view(),
        name="label_stats",
    ),
    path(
        route="projects/<int:project_id>/manual-discrepancies",
        view=ManualDiscrepancyListCreate.as_view(),
        name="manual-discrepancy-list",
    ),
    path(
    ...
    path(
        route="projects/<int:project_id>/discussions/<int:discussion_id>",
        view=DiscussionDetail.as_view(),
        name="discussion_detail",
    ),
    path(
        route="projects/<int:project_id>/discussions/<int:discussion_id>/messages",
        view=DiscussionMessageList.as_view(),
        name="discussion_message_list",
    ),
    path(
        route="projects/<int:project_id>/discussions/<int:discussion_id>/messages/<int:message_id>",
        view=DiscussionMessageDetail.as_view(),
        name="discussion_message_detail",
    ),
    # Rules
    ...
    path(
        route="projects/<int:project_id>/rules/<int:rule_id>/close-vote/",
        view=CloseRuleVote.as_view(),
        name="close-rule-vote",
    ),
    path(
        route="projects/<int:project_id>/rules/<int:rule_id>/reopen-vote/",
        view=ReopenRuleVote.as_view(),
        name="reopen-rule-vote",
    ),
