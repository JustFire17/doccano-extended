...
from .serializers import CustomRegisterSerializer, UserSerializer, UserUpdateSerializer
    ...
    def delete(self, request, user_id):
        try:
            ...
            if Member.objects.filter(user=user).exists():
                ...
                user.save()
                return Response(
                    {"message": "User has been deactivated because they are associated with projects"},
