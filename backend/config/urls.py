...
schema_view = get_schema_view(
    openapi.Info(
        title="doccano Extended API",
        default_version="v1",
        description=(
            "doccano Extended - Multi-perspective annotation platform with "
            "versioning, rules, discussions, and quality control"
        ),
        license=openapi.License(name="MIT License"),
        contact=openapi.Contact(email="support@doccano.com"),
    ),
    public=True,
