...
_client_static_dir = path.join(BASE_DIR, "client/dist/static")
STATICFILES_DIRS = [_client_static_dir] if path.exists(_client_static_dir) else []
...
CORS_ALLOW_CREDENTIALS = True  # Permitir envio de cookies com as requisições
CORS_ALLOW_HEADERS = ['*']  # Permitir todos os headers
...
if DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = [
        ...
        "http://10.20.71.164:3000",
        "http://10.20.71.213:3000",
        ...
        "http://localhost/users:3000",
        "http://10.20.71.144:3000",
        "http://192.168.1.102:3000",
        "http://10.20.67.188:3000",
        "http://192.168.1.87:3000",
        "http://10.33.33.1:3000",
