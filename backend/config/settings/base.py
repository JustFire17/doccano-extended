...
# Generate a new key with: python -c "from django.core.management.utils import (
...
if DEBUG:
    ...
    # Allow any host in development (not recommended for production)
    if env.bool("ALLOW_ALL_HOSTS", False):
        ALLOWED_HOSTS = ["*"]
else:
    # Production: Strict CORS - must be configured
