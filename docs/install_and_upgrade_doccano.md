...
You can override the default setting by rewriting the `.env` file. See [./docker/.env.example](https://github.com/JustFire17/doccano-extended/blob/master/docker/.env.example) in detail.
